...
VkResult ValidationLayering::createDebugUtilsMessengerEXT(
...
void ValidationLayering::DestroyDebugUtilsMessengerEXT(
    VkInstance instance,
...
void ValidationLayering::setupDebugMessenger(VkInstance instance) {
...
void ValidationLayering::populateDebugMessengerCreateInfo(
    VkDebugUtilsMessengerCreateInfoEXT &createInfo) {
  createInfo = {};
  createInfo.sType = VK_STRUCTURE_TYPE_DEBUG_UTILS_MESSENGER_CREATE_INFO_EXT;
  createInfo.messageSeverity = VK_DEBUG_UTILS_MESSAGE_SEVERITY_VERBOSE_BIT_EXT |
